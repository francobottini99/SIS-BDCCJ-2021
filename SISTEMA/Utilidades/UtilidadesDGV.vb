Public Class UtilidadesDGV
    ...
    Public Shared Sub FormatoDGVGeneral(ByRef DGV As DataGridView)
        ...
        DGV.RowsDefaultCellStyle.Font = New Font("Trebuchet MS", 10)
        ...
        DGV.AlternatingRowsDefaultCellStyle.Font = New Font("Trebuchet MS", 10)
        ...
        DGV.ColumnHeadersDefaultCellStyle.Font = New Font("Trebuchet MS", 10, FontStyle.Bold)
